...
export default function DealerPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 md:px-6">
      ...
      <div className="mt-8 flex flex-wrap gap-3"><Link href="/cars" className="rounded-lg bg-yard-500 px-5 py-3 font-semibold text-white">See the marketplace</Link><a href="mailto:hello@motoyard.co.ke" className="rounded-lg border border-yard-500 px-5 py-3 font-semibold text-yard-600">Talk to our team</a></div>
    </main>
  );
}
